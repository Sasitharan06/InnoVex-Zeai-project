...
const GUIDE_DATA = {
  ...
  'refraction': {
    title: 'Snell\'s Law (Semicircular Glass Disc)',
    domain: 'Physics',
    color: '#8b5cf6',
    icon: '🔍',
    overview: 'Verification of Snell\'s Law (sin i / sin r = constant) using a laser pointer, protractor scale, and semicircular glass disc on a white chart paper.',
    steps: [
      '(1) Take a wooden plank and cover it with a clean white chart paper.',
      '(2) Draw two perpendicular lines MM (interface line) and NN (normal line) intersecting at center point O.',
      '(3) MM represents the interface between air and glass, and NN is the normal at point O.',
      '(4) Place a protractor along line NN with its center coinciding at O and mark angles from 0° to 90° on both sides.',
      '(5) Place a semi-circular glass disc so its flat diameter coincides with MM and center at point O.',
      '(6) Point laser light along line NN (0° incidence) — light propagates straight from air to glass through O without bending.',
      '(7) Direct laser light at 15° incidence angle (i) passing through point O. Measure corresponding angle of refraction (r) inside glass.',
      '(8) Calculate sin i, sin r, and the ratio (sin i / sin r). Record values in the observation table.',
      '(9) Repeat experiment for angles of incidence i = 20°, 25°, 30°, and 35°.',
      '(10) Verify that in each case, the ratio (sin i / sin r) remains CONSTANT (n ≈ 1.50 for glass).',
    ],
    formulaTitle: 'Snell\'s Law & Refractive Index Equations',
    formulas: [
      { label: 'Snell\'s Law Ratio', eq: '\\frac{\\sin i}{\\sin r} = n = \\text{constant}' },
      { label: 'Refracted Angle Formula', eq: 'r = \\arcsin\\left( \\frac{\\sin i}{n} \\right)' },
      { label: 'Refractive Index of Glass', eq: 'n = \\frac{c}{v_{\\text{glass}}} \\approx 1.50' },
    ],
    calculationExample: 'Air n₁=1.0, Glass n₂=1.5. For i = 15°: sin 15° = 0.2588 ⟹ sin r = 0.2588 / 1.5 = 0.1725 ⟹ r = 9.9° ⟹ sin i / sin r = 1.50.',
    concept: 'When light passes from rarer (air) to denser medium (glass), it bends towards the normal NN. At the curved semicircular boundary, rays exit along radius normal without secondary bending.',
    safety: 'Avoid shining laser light into eyes. Use protective eyewear when aligning optical laser components.',
  },
